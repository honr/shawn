 ...
 */
template < typename T, typename ReadType, typename WriteType, TraciConstants::DataType TraciTypeId,
 ...
 */
template < typename T, TraciConstants::DataType TraciTypeId,
 ...
 */
//@{
typedef MessageHandlerSimple<unsigned char, int, int, TraciConstants::TypeUbyte,
    &tcpip::Storage::readUnsignedByte, &tcpip::Storage::writeUnsignedByte> MessageHandlerUbyte;

typedef MessageHandlerSimple<signed char, int, int, TraciConstants::TypeByte,
    &tcpip::Storage::readByte, &tcpip::Storage::writeByte> MessageHandlerByte;

typedef MessageHandlerSimpleSameType<int, TraciConstants::TypeInteger,
    &tcpip::Storage::readInt, &tcpip::Storage::writeInt> MessageHandlerInteger;

typedef MessageHandlerSimpleSameType<float, TraciConstants::TypeFloat,
    &tcpip::Storage::readFloat, &tcpip::Storage::writeFloat> MessageHandlerFloat;

typedef MessageHandlerSimpleSameType<double, TraciConstants::TypeDouble,
...
struct MessageHandlerString : public MessageHandlerSimple<std::string, std::string, const std::string &,
    TraciConstants::TypeString, &tcpip::Storage::readString, &tcpip::Storage::writeString>
{
 ...
 *          complications.
 */
struct MessageHandlerStringList : public MessageHandler< std::vector<std::string>, TraciConstants::TypeStringlist >
{
