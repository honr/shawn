...
struct DynamicLengthValue : public std::vector<ElementType>
{
 ...
 */
template < class DynamicLengthValueType, TraciConstants::DataType TraciTypeId = TraciConstants::TypeCompound >
...
typedef MessageHandlerDynamicLength< PolygonPointContainer, TraciConstants::TypePolygon > MessageHandlerPolygon;
...
/// Message handler for polygons
typedef MessageHandlerDynamicLength< TrafficLightPhaseContainer, TraciConstants::TypeTlphaselist > MessageHandlerTrafficLightPhaseList;
/// TraciType for polygon without type info
