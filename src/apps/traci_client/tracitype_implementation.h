...
//--------------------------------------------------------------------
/**
 *  GenTraciType::withTypeId will not be touched. Instead it calls the assignment
 *  operator TraciType::operator= of the base class and the value assignment
 *  operator GenTraciType::operator=(const ValueType &). Hence this copy
 *  assignment is also sufficient for derived classes.
 */
template<class MyMessageHandler, bool WithTypeId>
GenTraciType<MyMessageHandler, WithTypeId> &
GenTraciType<MyMessageHandler, WithTypeId>::operator= ( const ThisGenTraciType & other )
{
    if ( &other != this )
    {
...
//--------------------------------------------------------------------
template<class MyMessageHandler, bool WithTypeId>
TraciConstants::DataType GenTraciType<MyMessageHandler, WithTypeId>::getTraciTypeId() const
{
