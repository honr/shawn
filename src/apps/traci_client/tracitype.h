...
struct MessageHandler
{
     ...
     */
    virtual TraciConstants::DataType getTraciTypeId( const ValueType & value ) const
    {
        return TraciTypeId;
    }
...
public:
    /// Get TraCI type ID.
    virtual TraciConstants::DataType getTraciTypeId() const = 0;
...
public:
     ...
     */
    //@{
    /// Assign another GenTraciType (doesn't assign GenTraciType::withTypeId).
    virtual ThisGenTraciType & operator= ( const ThisGenTraciType & other );
    ...
    virtual bool operator==( const TraciType & other ) const;
    /// Get TraCI type ID.
    virtual TraciConstants::DataType getTraciTypeId() const;
