...
namespace shawn_server
{
   ...
   // -----------------------------------------------------------------------
   int __shawnts__defineNetwork( soap*,
            shawnts__defineNetwork *shawnts__defineNetwork_,
            shawnts__defineNetworkResponse *shawnts__defineNetworkResponse_ )
   {
      // TODO !
      std::cout << "shawn::testbedservice::defineNetwork" << std::endl;
      return SOAP_OK;
   }
   // -----------------------------------------------------------------------
   int __shawnts__describeCapabilities( soap*,
   ...
   {
      // TODO !
      std::cout << "shawn::testbedservice::describeCapabilities" << std::endl;
      return SOAP_OK;
   }
   // -----------------------------------------------------------------------
