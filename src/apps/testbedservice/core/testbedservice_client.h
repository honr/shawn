...
namespace testbedservice
{
   ...
   public:
      ...
      void send_text_message( std::string& source, std::string& msg, int level ) throw();
      void send_binary_message( std::string& source, int len, uint8_t* buf ) throw();
   ...
   private:
      void call_receive_status( shawnts__receiveStatus *rcv_status );
      void call_receive_message( shawnts__receive *receive );
      // --------------------------------------------------------------------
